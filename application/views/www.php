...
<html lang="en">
  <head>
      <!-- navbar -->
    <nav class="navbar navbar-light justify-content-between p-3" style="background: #0049A8;">
        <a class="font-family: Poppins; font-style: normal; font-weight: bold; font-size: 25px; line-height: 37px; display: flex; align-items: center; letter-spacing: 0.09em; color: #FFFFFF;" style="font-family: Poppins; font-style: normal; font-weight: bold; font-size: 25px; line-height: 37px; display: flex; align-items: center; letter-spacing: 0.09em; color: #FFFFFF;">BALESUPPLY</a>
        <div class="form-inline">
            <span class="btn btn-outline-light my-2 my-sm-0"><i class="fa fa-shopping-cart"></i></span>
        </div>
    </nav>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
                ...
                <div class="col-6 col-md-2">
                    <div style="float:right; transform: translateY(25px); width:55px; height:55px; border-radius: 100%; left: 196px; top: 978px; background: #FC185A; border: 3px solid rgba(255, 255, 255, 0.6);">
                        ...
                        <div class="card" style="width:100%; height:344px; position:initial; border-radius:0px 0px 80px 80px; background: #FAFAFA; box-shadow: 0px -7px 80px rgba(0, 0, 0, 0.07), 0px -2.92443px 33.4221px rgba(0, 0, 0, 0.0503198), 0px -1.56354px 17.869px rgba(0, 0, 0, 0.0417275), 0px -0.876509px 10.0172px rgba(0, 0, 0, 0.035), 0px -0.465507px 5.32008px rgba(0, 0, 0, 0.0282725), 0px -0.193708px 2.21381px rgba(0, 0, 0, 0.0196802);">
                            <img src="assets/img/gambar4.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <div class="col-md-12">
                    ...
                    <div class="card" style="height:336px; background: #FAFAFA; box-shadow: 0px -7px 80px rgba(0, 0, 0, 0.07), 0px -2.92443px 33.4221px rgba(0, 0, 0, 0.0503198), 0px -1.56354px 17.869px rgba(0, 0, 0, 0.0417275), 0px -0.876509px 10.0172px rgba(0, 0, 0, 0.035), 0px -0.465507px 5.32008px rgba(0, 0, 0, 0.0282725), 0px -0.193708px 2.21381px rgba(0, 0, 0, 0.0196802);">
                      <img src="assets/img/gambar4.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="card-text" style="width: 192px; height: 34px; left: 70px; top: 2285px; font-family: Inter; font-style: normal; font-weight: 300; font-size: 20px; line-height: 24px; display: flex; align-items: center; color: #222222;">Sepatu</p>
                                </div>
                                    <div class="col-md-12 d-flex justify-content-start " style="bottom: 0;position: absolute;">
                                        <p class="card-text" style="width: 192px; height: 34px; left: 70px; top: 2351px; font-family: Inter; font-style: normal; font-weight: 500; font-size: 20px; line-height: 24px; display: flex; align-items: center; color: #222222;">Rp 500.000</p>
                                    </div>
        ...
        <div class="container-fluid text-center">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <img src="assets/img/belanja1.jpg" style="width: 444px; height: 444px; left: 111px; top: 3776px; background: #C4C4C4;" class="card-img-top" alt="...">
                    </div>
                        <div class="col-md-6 ext-center text-lg-start">
                            <h5>Beginilah Cara Belanja Dengan Mudah</h5>
                            <table>
                                <tr>
                                    <td style=" border-radius:100%; width: 30px; height: 30px; left: 740px; top: 3906px; background: #FFFFFF; box-shadow: 0px 28px 80px rgba(0, 0, 0, 0.11), 0px 11.6977px 33.4221px rgba(0, 0, 0, 0.079074), 0px 6.25417px 17.869px rgba(0, 0, 0, 0.0655718), 0px 3.50603px 10.0172px rgba(0, 0, 0, 0.055), 0px 1.86203px 5.32008px rgba(0, 0, 0, 0.0444282), 0px 0.774832px 2.21381px rgba(0, 0, 0, 0.030926);">1</td>
                                ...
                                <tr>
                                    <td  style=" border-radius:100%; width: 30px; height: 30px; left: 740px; top: 3906px; background: #FFFFFF; box-shadow: 0px 28px 80px rgba(0, 0, 0, 0.11), 0px 11.6977px 33.4221px rgba(0, 0, 0, 0.079074), 0px 6.25417px 17.869px rgba(0, 0, 0, 0.0655718), 0px 3.50603px 10.0172px rgba(0, 0, 0, 0.055), 0px 1.86203px 5.32008px rgba(0, 0, 0, 0.0444282), 0px 0.774832px 2.21381px rgba(0, 0, 0, 0.030926);">2</td>
                                ...
                                <tr>
                                    <td  style=" border-radius:100%; width: 30px; height: 30px; left: 740px; top: 3906px; background: #FFFFFF; box-shadow: 0px 28px 80px rgba(0, 0, 0, 0.11), 0px 11.6977px 33.4221px rgba(0, 0, 0, 0.079074), 0px 6.25417px 17.869px rgba(0, 0, 0, 0.0655718), 0px 3.50603px 10.0172px rgba(0, 0, 0, 0.055), 0px 1.86203px 5.32008px rgba(0, 0, 0, 0.0444282), 0px 0.774832px 2.21381px rgba(0, 0, 0, 0.030926);">3</td>
                ...
                <div class="col-md-6">
                    <p style="font-family: Poppins; font-style: normal; font-weight: normal; font-size: 23px; line-height: 34px; display: flex; align-items: center; color: #015EB6;"><h5>Beginilah Cara Bertransaksi Dengan Aman</h5></p>
                ...
                <div class="col-md-6">
                    <img src="assets/img/belanja2.jpg" style="width: 500px; height: 444px; left: 111px; top: 3776px; background: #C4C4C4;" class="card-img-top" alt="...">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Footer -->
        <footer class="text-center text-lg-start text-muted" style="background: #015EB6; display:none;">
        ...
        <!-- Copyright -->
        <div class="text-center p-3" style="background: #0049A8;">
            © 2021 Copyright:
