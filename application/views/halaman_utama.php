                                        ...
                                        <div class="col-md-7 text-left">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-12 text-right">
                                                    <div class="container">
                                                    <a href="<?= base_url() ?>detail_keranjang">   
                                                    <button type="button" class=" btn btn-warning" data-dismiss="modal" onclick="incrementValue()" value="plus" aria-hidden="true"><i class="fa fa-shopping-cart"></i>    tambahkan ke troli</button>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-12 text-right">
                                                        <div class="container">
                                                            <!-- Button beli sekarang -->
                                                              ...
                                                              <button class="btn btn-warning" name ="btn_add_cart" type="submit" aria-hidden="true">Tambah ke Keranjang</button>
                                                            <!-- </a> -->
                                                </form>
                                                <!--Form konfirmasi pembelian -->
