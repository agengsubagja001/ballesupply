			...
			<section class="pt-3" style="background: #015EB6;">
				...
				<div class="row mt-3" style="color: #fff;">
					...
					<div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
						<!-- Content -->
						<h6 class="text-white fw-bold mb-4"><i class="fas fa-gem me-3"></i>Tentang Kami</h6>
						<p class="text-white">
					...
					<div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
						...
						<table>
							<tr>
								<td><i class="fa fa-map-marker" aria-hidden="true" style="transform: translateY(-33px);"></i></td>
								<td></td>
